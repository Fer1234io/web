...
const routes = [
  ...
  },
  {
    ...
    children: [
      { path: "stats", name: "Perfil", component: () => import("@/pages/UserProfile.vue") },
      { path: "Vista", name: "Ventas", component: () => import("@/components/Prueba/Vista.vue") },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "historial", name: "cliente-historial", component: () => import("@/components/Clientes/Historial.vue") },
